        ...
        <div className="flex-auto w-80  flex flex-col justify-center text-center items-center  gap-1">
          ...
          <div data-aos={"slide-up"} className="text-center">
            ...
            <div className="text-white flex flex-row gap-7 w-fit mx-auto pt-4">
              <div
                onClick={() =>
                  window.open("https://github.com/PADDA-YOGESHWAR", "_blank")
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://instagram.com/yog_eshwar_lucky",
                    "_blank"
                  )
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "http://www.linkedin.com/in/padda-yogeshwara-rao-751295212",
                    "_blank"
                  )
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://twitter.com/YogeshLucky3",
                    "_blank"
                  )
                }
              >
            ...
            <div className="mt-6 italic text-center font-medium text-blue-500 ">
              <span className=" pl-1 "><a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/"><img className="img-fluid" style = {{marginTop: `${-30}px`, marginLeft:`${360}px`}}height={100}
          width={100} alt="Creative Commons Licence" src="https://i.creativecommons.org/l/by-nc-sa/4.0/88x31.png" /></a><br />This work is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/">Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License</a></span>
              <CopyrightIcon className="cursor-pointer mx-1" />
              <span>2023 PADDA YOGESHWARA RAO</span>
            </div>
          </div>
        </div>
        <ToastContainer
